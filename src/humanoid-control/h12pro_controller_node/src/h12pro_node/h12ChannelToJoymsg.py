...
class H12ToJoyControllerNode:
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.channel_mapping = {
            ...
            8: ChannelMapping(channel=8, button_index=BUTTON_X, is_button=True, trigger_value=H12_AXIS_RANGE_MAX),#B(X)
            9: ChannelMapping(channel=9, button_index=BUTTON_LB, is_button=True, trigger_value=H12_AXIS_RANGE_MAX),#C(LB)
